...
if __name__ == '__main__':
    ...
    while True:
        ...
        mg_mask, mg_orient = cv2.motempl.calcMotionGradient(motion_history, MAX_TIME_DELTA, MIN_TIME_DELTA, apertureSize=3)
        ...
        for i, rect in enumerate([(0, 0, w, h)] + list(seg_bounds)):
            ...
            # cv2.imwrite('silh_roi.png', silh_roi)
            # cv2.imwrite('orient_roi.png', orient_roi)
            # cv2.imwrite('mask_roi.png', mask_roi)
            # cv2.imwrite('mhi_roi.png', mhi_roi)
